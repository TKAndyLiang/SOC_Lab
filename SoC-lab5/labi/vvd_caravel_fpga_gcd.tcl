...
set _xil_proj_name_ "vvd_caravel_fpga_gcd"
...
set script_file "vvd_caravel_fpga_gcd.tcl"
...
set orig_proj_dir "[file normalize "$origin_dir/vvd_caravel_fpga_gcd"]"
...
if { [get_property IS_LOCKED [ get_files -norecurse design_1.bd] ] == 1  } {
  import_files -fileset sources_1 [file normalize "${origin_dir}/vvd_caravel_fpga_gcd/vvd_caravel_fpga_gcd.gen/sources_1/bd/design_1/hdl/design_1_wrapper.v" ]
} else {
...
set obj [get_runs synth_1]
set_property -name "auto_incremental_checkpoint.directory" -value "/home/tonyho/workspace_willy/caravel_fpga/project/vitis_hls_project/hls_read_romcode/D:/Caravel_Soc/vvd_caravel_fpga_gcd/vvd_caravel_fpga_gcd.srcs/utils_1/imports/synth_1" -objects $obj
...
set obj [get_runs impl_1]
set_property -name "auto_incremental_checkpoint.directory" -value "/home/tonyho/workspace_willy/caravel_fpga/project/vitis_hls_project/hls_read_romcode/D:/Caravel_Soc/vvd_caravel_fpga_gcd/vvd_caravel_fpga_gcd.srcs/utils_1/imports/impl_1" -objects $obj
