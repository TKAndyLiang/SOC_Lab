# 0 "function.c"
# 1 "/home/ubuntu/final_project/lab-wlos_baseline/testbench/top//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "function.c"
# 1 "../../firmware/defs.h" 1
...
# 1 "function.h" 1
 ...
 int QS[10] = {893, 40, 3233, 4267, 2669, 2541, 9073, 6023, 5681, 4622};
...
void __attribute__ ( ( section ( ".mprjram" ) ) ) initfir() {
 ...
 (*(volatile uint32_t*)0x31000040) = 0;
 (*(volatile uint32_t*)0x31000044) = -10;
 (*(volatile uint32_t*)0x31000048) = -9;
 (*(volatile uint32_t*)0x3100004c) = 23;
 (*(volatile uint32_t*)0x31000050) = 56;
 (*(volatile uint32_t*)0x31000054) = 63;
 (*(volatile uint32_t*)0x31000058) = 56;
 (*(volatile uint32_t*)0x3100005c) = 23;
 (*(volatile uint32_t*)0x31000060) = -9;
 (*(volatile uint32_t*)0x31000064)= -10;
 (*(volatile uint32_t*)0x31000068)= 0;

 (*(volatile uint32_t*)0x31000010) = 64;
 (*(volatile uint32_t*)0x31000014) = 0x380010a8;
 (*(volatile uint32_t*)0x31000018) = 0x380011f0;
...
int* __attribute__ ( ( section ( ".mprjram" ) ) ) fir(){
 ...
 s = (*(volatile uint32_t*)0x31000000);
 while(!((s >> 1) & 1)) {
  s = (*(volatile uint32_t*)0x31000000);
 }

 (*(volatile uint32_t*)0x2600000c) = 0xFF5A0000;
